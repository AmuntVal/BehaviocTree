...
namespace behaviac
{
	...
	public class BehaviorLoaderImplement : BehaviorLoader
	{
		...
		{
			AgentMeta.TotalSignature = 563639615;
			...
			meta.RegisterMethod(393137287, new CAgentMethod<behaviac.EBTStatus>(delegate(Agent self) { return ((HoverBotAgent)self).DoEscape(); }));
